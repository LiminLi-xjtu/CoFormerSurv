...
cancer_list = ['HNSC']
source_file_path = 'Collaborative_Transformer/Datasets_and_Preprocessing/data/miRNA_source_to_csv'
target_file_path = 'Collaborative_Transformer/Datasets_and_Preprocessing/data/miRNA_variable_filter_csv/'
